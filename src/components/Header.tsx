...
export function Header() {
  ...
  return (
    ...
    >
      <a href="https://github.com/NgocHuyen2309" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-purple-950 hover:text-amber-500 transition-colors cursor-pointer bg-white/70 backdrop-blur-md px-4 py-2 rounded-full border border-purple-100/50 shadow-sm">
